...
void tranfo_chaine_nature() {
   ...
   if (strcmp(lexeme_en_cours.chaine,"AND")==0 || strcmp(lexeme_en_cours.chaine,"and")==0){
      lexeme_en_cours.nature=AND;
      return;
   }
   if (strcmp(lexeme_en_cours.chaine,"OR")==0 || strcmp(lexeme_en_cours.chaine,"or")==0){
      lexeme_en_cours.nature=OR;
      return;
   }
